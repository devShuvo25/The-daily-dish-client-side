          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            >
              ...
              <span className="text-primary relative inline-block">
                ...
                >
                  <path
                    d="M2.00025 6.99997C25.7956 2.87181 20.6533 1.09613 63.8562 2.76611C87.6517 3.68595 142.176 1.70059 197.971 6.99997"
                    stroke="currentColor"
                    strokeWidth="3"
                    strokeLinecap="round"
                  />
            ...
            >
              The Daily Dish connects you with passionate home cooks in your
              neighborhood. Experience authentic flavors, healthy ingredients,
              and the warmth of a homemade dinner without the cooking. We
              believe good food brings communities together.
            </motion.p>
            ...
            <div className="relative z-10 grid grid-cols-2 gap-4">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-100 rounded-2xl p-6 h-40 flex items-center justify-center">
                  <div className="text-center">
                    <span className="block text-4xl font-bold text-gray-800 mb-1">
                      100%
                    </span>
