        ...
        >
          ...
          >
            <button
              ...
              className="btn btn-primary btn-lg rounded-full px-10 text-white shadow-lg hover:shadow-primary/50 hover:-translate-y-1 transition-all duration-300 transform w-full sm:w-auto border-none"
            >
              Explore Menus
            ...
            <button
              ...
              className="btn btn-lg rounded-full px-10 bg-white/10 backdrop-blur-md border border-white/40 text-white hover:bg-white hover:text-primary shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto group"
            >
              Become a Chef
